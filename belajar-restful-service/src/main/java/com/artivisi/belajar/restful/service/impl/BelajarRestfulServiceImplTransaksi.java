...
import com.artivisi.belajar.restful.service.BelajarRestfulServiceTransaksi;

@Service("belajarRestfulServiceTransaksi")
@Transactional
public class BelajarRestfulServiceImplTransaksi implements BelajarRestfulServiceTransaksi {
/*
    @Autowired
